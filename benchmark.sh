...
function py_requirements () {
  ...
  if [ $2 == 101 ]; then
    if [ $1 == 36 ]; then
        wget https://paddle-wheel.bj.bcebos.com/with-trt/2.1.0-gpu-cuda10.1-cudnn7-mkl-gcc8.2/paddlepaddle_gpu-2.1.0.post101-cp36-cp36m-linux_x86_64.whl
    elif [ $1 == 37 ]; then
        wget https://paddle-wheel.bj.bcebos.com/with-trt/2.1.0-gpu-cuda10.1-cudnn7-mkl-gcc8.2/paddlepaddle_gpu-2.1.0.post101-cp37-cp37m-linux_x86_64.whl
    elif [ $1 == 38 ]; then
        wget https://paddle-wheel.bj.bcebos.com/with-trt/2.1.0-gpu-cuda10.1-cudnn7-mkl-gcc8.2/paddlepaddle_gpu-2.1.0.post101-cp38-cp38-linux_x86_64.whl
    fi
  elif [ $2 == 102 ]; then
    if [ $1 == 36 ]; then
        wget https://paddle-wheel.bj.bcebos.com/with-trt/2.1.0-gpu-cuda10.2-cudnn8-mkl-gcc8.2/paddlepaddle_gpu-2.1.0-cp36-cp36m-linux_x86_64.whl
    elif [ $1 == 37 ]; then
        wget https://paddle-wheel.bj.bcebos.com/with-trt/2.1.0-gpu-cuda10.2-cudnn8-mkl-gcc8.2/paddlepaddle_gpu-2.1.0-cp37-cp37m-linux_x86_64.whl
    elif [ $1 == 38 ]; then
        wget https://paddle-wheel.bj.bcebos.com/with-trt/2.1.0-gpu-cuda10.2-cudnn8-mkl-gcc8.2/paddlepaddle_gpu-2.1.0-cp38-cp38-linux_x86_64.whl
    fi
  elif [ $2 == 110 ]; then
    if [ $1 == 36 ]; then
        wget https://paddle-wheel.bj.bcebos.com/with-trt/2.1.0-gpu-cuda11.0-cudnn8-mkl-gcc8.2/paddlepaddle_gpu-2.1.0.post110-cp36-cp36m-linux_x86_64.whl
    elif [ $1 == 37 ]; then
        wget https://paddle-wheel.bj.bcebos.com/with-trt/2.1.0-gpu-cuda11.0-cudnn8-mkl-gcc8.2/paddlepaddle_gpu-2.1.0.post110-cp37-cp37m-linux_x86_64.whl
    elif [ $1 == 38 ]; then
    ...
    if [ $1 == 36 ]; then
        wget https://paddle-wheel.bj.bcebos.com/2.1.0-cpu-avx-mkl/paddlepaddle-2.1.0-cp36-cp36m-linux_x86_64.whl
    elif [ $1 == 37 ]; then
        wget https://paddle-wheel.bj.bcebos.com/2.1.0-cpu-avx-mkl/paddlepaddle-2.1.0-cp37-cp37m-linux_x86_64.whl
    elif [ $1 == 38 ]; then
        wget https://paddle-wheel.bj.bcebos.com/2.1.0-cpu-avx-mkl/paddlepaddle-2.1.0-cp38-cp38-linux_x86_64.whl
    fi
  else
...
function generate_logs() {
  ...
  mkdir -p ../logs_output/${today}_${commit_id}/${ce_name}/benchmark_excel
  # 汇总信息
...
function pipeline_darknet53() {
    ...
    sh benchmark.sh
    tail profile_log_clas-DarkNet53
    # 日志处理
    ...
    sed -i "s/runtime_device: "cpu"/runtime_device: "gpu"/g" config.yml
    $py_version parse_profile.py --benchmark_cfg benchmark_cfg.yaml --benchmark_log profile_log_clas-DarkNet53
    $py_version benchmark_analysis.py --log_path ./benchmark_logs
